...
function mix(a, b, t) {
  ...
  const A = h(a), B = h(b);
  return "#" + A.map((v, i) => {
    const n = Math.round(v + (B[i] - v) * t).toString(16);
    return n.length < 2 ? "0" + n : n;
  }).join("");
}

/* the silhouettes, drawn from simple primitives so they stay crisp at 26px */
function shape(kind, M, D, L) {
  switch (kind) {
    case "hat":
      return (<>
        <path d="M14.6 40.5 L15.4 20.6 Q15.4 17.8 24 17.8 Q32.6 17.8 32.6 20.6 L33.4 40.5 Z" fill={M} />
        <path d="M15 33.4 L33 33.4 L33.2 37 L14.8 37 Z" fill={D} />
        <ellipse cx="24" cy="40.6" rx="15.4" ry="4.3" fill={M} />
        <ellipse cx="24" cy="39.4" rx="15.4" ry="4.3" fill={L} />
        <ellipse cx="24" cy="18" rx="8.6" ry="2.5" fill={L} />
      </>);
    case "car":
      return (<>
        <path d="M5 39.5 C5 34.8 8.2 32.6 13.4 32.1 L18 25.6 C19.1 23.9 20.6 23.1 22.6 23.1 L28.4 23.1
          C30.9 23.1 32.4 24.1 33.3 26.1 L36.1 32.1 C41.4 32.6 43.8 34.8 43.8 39.5 Z" fill={M} />
        <ellipse cx="24.6" cy="28.4" rx="4.4" ry="2.9" fill={D} />
        <path d="M18.4 25.9 L30.6 25.9" stroke={D} strokeWidth="1" strokeLinecap="round" opacity=".8" />
        <circle cx="14.2" cy="40" r="5.6" fill={D} />
        <circle cx="34" cy="40" r="5.6" fill={D} />
        <circle cx="14.2" cy="40" r="2.5" fill={L} />
        <circle cx="34" cy="40" r="2.5" fill={L} />
      </>);
    case "dog":
      return (<>
        <rect x="17" y="35.5" width="3.8" height="7.5" rx="1.6" fill={D} />
        <rect x="30" y="35.5" width="3.8" height="7.5" rx="1.6" fill={D} />
        <rect x="14.5" y="26.5" width="21" height="12" rx="5.6" fill={M} />
        <rect x="21.5" y="35.5" width="3.8" height="7.5" rx="1.6" fill={M} />
        <rect x="26" y="35.5" width="3.8" height="7.5" rx="1.6" fill={M} />
        <path d="M33.4 29.5 C37.6 27.4 39.8 22.6 38.2 20.4 C36.8 18.6 34.8 20.8 34.6 24 C34.4 26.4 33.8 28 32.6 28.6 Z" fill={M} />
        <circle cx="14.4" cy="25.6" r="6.3" fill={M} />
        <path d="M9.6 21.6 L11.4 15.6 L14.8 20.4 Z" fill={M} />
        <path d="M15.4 20 L18.4 15.4 L19.8 21.4 Z" fill={M} />
        <path d="M4.6 25 L12 24 L12 29.6 L5.4 28.6 C4.2 28.4 4 25.2 4.6 25 Z" fill={M} />
        <circle cx="5.6" cy="26.4" r="1.2" fill={D} />
        <circle cx="12.6" cy="23.4" r="1" fill={D} />
        <path d="M15 30 C18 32 22 32.6 26 32" stroke={D} strokeWidth=".9" fill="none" opacity=".7" />
      </>);
    case "cat":
      return (<>
        <path d="M12.5 40 C11 31.5 15 26 23.5 26 C31.5 26 35.5 30.5 35.5 40 Z" fill={M} />
        <rect x="15" y="36" width="3.6" height="7" rx="1.6" fill={D} />
        <rect x="29" y="36" width="3.6" height="7" rx="1.6" fill={D} />
        <rect x="20" y="36.5" width="3.6" height="6.5" rx="1.6" fill={M} />
        <rect x="25" y="36.5" width="3.6" height="6.5" rx="1.6" fill={M} />
        <path d="M35 33 C40 32 42.5 27 40.6 21.6 C39.8 19.4 37.6 20 38.2 22.6 C39.4 27 37.6 29.6 34 30.4 Z" fill={M} />
        <circle cx="15.6" cy="24.4" r="6.4" fill={M} />
        <path d="M10.4 20.6 L11 14.8 L15.4 19.4 Z" fill={M} />
        <path d="M16.8 19.2 L21 15 L21.2 21 Z" fill={M} />
        <circle cx="13.2" cy="23.8" r="1.1" fill={D} />
        <circle cx="18.4" cy="23.8" r="1.1" fill={D} />
        <path d="M14.4 27.4 L16.8 27.4" stroke={D} strokeWidth=".9" strokeLinecap="round" />
      </>);
    case "duck":
      return (<>
        <path d="M13 35 C13 29 18.5 26 25 26 C33 26 39.5 30 39.5 36 C39.5 40.5 34 43 26 43
          C18 43 13 40 13 35 Z" fill={M} />
        <path d="M36 27.5 C40.5 25.5 43.5 26.5 43 29.5 C42.6 32 40 33.5 37.5 33.5 Z" fill={L} />
        <circle cx="17.5" cy="21.5" r="7.2" fill={M} />
        <path d="M11 20.5 C7 20.5 4.5 22 4.5 23.6 C4.5 25.2 7.5 26.4 11.4 26 Z" fill={D} />
        <circle cx="19.4" cy="19.6" r="1.5" fill={D} />
        <circle cx="19" cy="19.1" r=".5" fill="#FFF" />
      </>);
    case "penguin":
      return (<>
        <ellipse cx="23" cy="32" rx="10.6" ry="13" fill={M} />
        <ellipse cx="23.5" cy="34.5" rx="6.6" ry="9.6" fill={L} />
        <circle cx="23" cy="17.5" r="7.6" fill={M} />
        <path d="M30 17 C34.5 17.6 37 18.8 37 19.8 C37 20.8 34 21.8 30 21.6 Z" fill={D} />
        <circle cx="26.4" cy="15.8" r="1.4" fill={D} />
        <circle cx="26" cy="15.3" r=".5" fill="#FFF" />
        <path d="M12.6 25 C9.6 29 9.6 36 12.4 40 C14 41.4 14.6 39 14 36 C13.4 32.6 13.6 28.6 14.6 25.6 Z" fill={M} />
        <ellipse cx="18.5" cy="44.2" rx="4.4" ry="2" fill={D} />
        <ellipse cx="27.5" cy="44.2" rx="4.4" ry="2" fill={D} />
      </>);
    case "ship":
      return (<>
        <rect x="22.6" y="12" width="1.5" height="9" fill={D} />
        <rect x="19.4" y="19.5" width="3.6" height="8" rx="1" fill={M} />
        <rect x="25" y="21" width="3.6" height="6.5" rx="1" fill={M} />
        <rect x="16" y="26.5" width="16" height="8.5" rx="1.6" fill={M} />
        <rect x="11" y="33" width="26" height="3.4" rx="1" fill={L} />
        <path d="M4.5 36.4 L43.5 36.4 C41.5 41.6 35 44.2 24 44.2 C13 44.2 6.5 41.6 4.5 36.4 Z" fill={M} />
        <path d="M9 39.4 L39 39.4" stroke={D} strokeWidth="1" strokeDasharray="1.4 2.6" strokeLinecap="round" />
        <rect x="33.4" y="28.5" width="4.6" height="4.5" rx="1" fill={D} />
      </>);
    case "iron":
      return (<>
        <path d="M13.5 32.5 C13.5 23.5 34.5 23.5 34.5 32.5" stroke={M} strokeWidth="3.4" fill="none" strokeLinecap="round" />
        <path d="M13.5 32.5 C13.5 25.5 34.5 25.5 34.5 32.5" stroke={L} strokeWidth="1.1" fill="none" strokeLinecap="round" />
        <path d="M5.5 40.4 C5.5 35.6 12 32.4 24.5 32.4 L40 32.4 C42.6 32.4 44 34.4 44 36.6
          C44 39.6 41.2 41.4 36 41.4 L10 41.4 C7.2 41.4 5.5 41.2 5.5 40.4 Z" fill={M} />
        <path d="M8 38.6 C9.5 35.5 15 33.6 25 33.6 L39.5 33.6" stroke={L} strokeWidth="1.2" fill="none" strokeLinecap="round" />
      </>);
    default:
      return null;
  }
...
function Token({ i, kind, cls }) {
  const c = PC[i], d = PCD[i];
  const k = "k" + i + (kind || "hat") + (cls || "");
  const M = "url(#m" + k + ")", D = "url(#d" + k + ")", L = "url(#l" + k + ")";
  return (
    <svg className={"pawn " + (cls || "")} viewBox="0 0 48 52" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id={"m" + k} x1="12%" y1="0%" x2="78%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" />
          <stop offset="18%" stopColor={mix("#EEF1F4", c, .07)} />
          <stop offset="42%" stopColor={mix("#B3BAC2", c, .16)} />
          <stop offset="58%" stopColor={mix("#767E87", d, .22)} />
          <stop offset="76%" stopColor={mix("#D3D9DF", c, .09)} />
          <stop offset="100%" stopColor={mix("#868E97", d, .2)} />
        </linearGradient>
        <linearGradient id={"d" + k} x1="12%" y1="0%" x2="78%" y2="100%">
          <stop offset="0%" stopColor={mix("#9AA2AB", c, .12)} />
          <stop offset="52%" stopColor={mix("#575E66", d, .26)} />
          <stop offset="100%" stopColor={mix("#3C424A", d, .3)} />
        </linearGradient>
        <linearGradient id={"l" + k} x1="12%" y1="0%" x2="78%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" />
          <stop offset="55%" stopColor={mix("#E4E9EE", c, .06)} />
          <stop offset="100%" stopColor={mix("#B4BBC3", c, .14)} />
        </linearGradient>
        <radialGradient id={"b" + k} cx="42%" cy="30%" r="72%">
          <stop offset="0%" stopColor={c} />
          <stop offset="100%" stopColor={d} />
        </radialGradient>
      </defs>
      <ellipse cx="24" cy="48.6" rx="15" ry="3.4" fill="#000" opacity=".52" />
      <ellipse cx="24" cy="47.4" rx="14.2" ry="3.3" fill={"url(#b" + k + ")"} />
      <ellipse cx="24" cy="46.3" rx="14.2" ry="3.3" fill={"url(#b" + k + ")"} />
      <ellipse cx="24" cy="45.6" rx="10.5" ry="1.9" fill="#FFFFFF" opacity=".22" />
      {shape(kind || "hat", M, D, L)}
    </svg>
  );
}
...
/* one-word tag used on the deed chips in the player rail */
function deedTag(sp) {
  if (sp.t === "util") return sp.name.toUpperCase().split(" ")[1];
  return cellLabel(sp).split(" ")[0];
}
...
.board { position: absolute; inset: 0; container-type: inline-size;
  transform-origin: 50% 50%; transition: transform .65s cubic-bezier(.2,.85,.25,1);
  background:
...
.iso .pulse { transform-style: preserve-3d; }
.hBtn3d { font-family: var(--cond); font-size: 11px; font-weight: 700; letter-spacing: .06em; }
...
.nm { font-family: var(--cond); font-weight: 600; line-height: 1.02; letter-spacing: .012em;
  color: #EFE8DC; text-align: center; max-width: 100%; word-break: keep-all; overflow-wrap: normal; hyphens: none; }
...
.tok { position: absolute; width: 5.7cqw; height: 6.2cqw; transform: translate(-50%,-84%);
...
.diceRow { display: flex; gap: 3cqw; touch-action: none; transition: transform .18s ease; }
.diceLive { cursor: grab; }
.diceLive:active { cursor: grabbing; }
.diceHeld { transition: none; }
.diceLive .die { box-shadow: 0 1.4cqw 2.6cqw rgba(0,0,0,.6), inset 0 -.6cqw .4cqw rgba(0,0,0,.14),
  inset 0 .5cqw 0 rgba(255,255,255,.7); }
.throwHint { font-family: var(--cond); font-size: 2.1cqw; letter-spacing: .18em; text-transform: uppercase;
  color: var(--dim2); animation: blink 2.4s ease infinite; }

.deckWrap { display: flex; flex-direction: column; align-items: center; gap: 14px; }
.deckTag { font-family: var(--cond); font-size: 12px; letter-spacing: .34em; color: var(--dim); text-transform: uppercase; }
.cardBack { width: 176px; height: 232px; border-radius: 16px; border: 1px solid var(--line2); border-top: 6px solid;
  background: repeating-linear-gradient(45deg, rgba(255,255,255,.045) 0 6px, transparent 6px 12px),
    linear-gradient(180deg, #221F1C, #16150F);
  display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px;
  cursor: pointer; box-shadow: 0 22px 60px rgba(0,0,0,.7); animation: popIn .35s cubic-bezier(.2,.9,.3,1.3);
  font-family: var(--ui); }
.cardBack:active { transform: scale(.96); }
.cbMark { font-family: var(--dis); font-size: 62px; line-height: 1; color: var(--gold); text-shadow: 0 0 26px rgba(215,169,75,.4); }
.cardC .cbMark { color: var(--teal); text-shadow: 0 0 26px rgba(79,168,149,.35); }
.cbHint { font-family: var(--cond); font-size: 11px; letter-spacing: .2em; text-transform: uppercase; color: var(--dim2); }
.dueBig { font-family: var(--dis); font-size: 40px; line-height: 1.1; margin: 2px 0 2px; }
.dueLbl { font-family: var(--cond); font-size: 11px; letter-spacing: .24em; text-transform: uppercase;
  color: var(--dim2); margin-top: 12px; }
.dueCard { border: 1px solid var(--line2); border-radius: 12px; overflow: hidden;
  background: linear-gradient(180deg, rgba(255,255,255,.06), rgba(255,255,255,.02)); }
.dueBar { height: 20px; box-shadow: inset 0 -2px 5px rgba(0,0,0,.4); }
.dueHead { display: flex; align-items: center; justify-content: space-between; gap: 10px; padding: 9px 11px 8px; }
.dueWho { min-width: 0; }
...
.dueOwnN { font-size: 12.5px; font-weight: 700; color: currentColor; }
.dueTab { margin: 0; border: none; border-top: 1px solid var(--line); border-radius: 0; background: transparent; }
.rNow { background: rgba(255,255,255,.09); }
.rNow span, .rNow b { color: var(--ink); }
...
.flt { position: absolute; right: 8px; top: -2px; font-size: 12px; font-weight: 700;
...
.suPawn { width: 30px; height: 32px; flex: none; }
.suTokBtn { border: none; background: transparent; padding: 0 2px 0 0; cursor: pointer; flex: none;
  line-height: 0; border-radius: 8px; }
.suTokBtn:active { transform: scale(.9); }
...
export default function TycoonGame() {
  ...
  /* the dice are thrown by flicking them, not by pressing a button */
  function throwStart(e) {
    const gg = Sr.current;
    if (!gg || gg.phase !== "pre" || gg.winner !== null) return;
    const p = gg.players[gg.cur];
    if (!p.human || p.inJail) return;
    e.currentTarget.setPointerCapture && e.currentTarget.setPointerCapture(e.pointerId);
    dragRef.current = { x0: e.clientX, y0: e.clientY, t0: Date.now() };
    setDrag({ dx: 0, dy: 0 });
  }
  function throwMove(e) {
    const d = dragRef.current;
    if (!d) return;
    const dx = e.clientX - d.x0, dy = e.clientY - d.y0;
    setDrag({ dx: Math.max(-70, Math.min(70, dx)), dy: Math.max(-70, Math.min(70, dy)) });
  }
  function throwEnd(e) {
    const d = dragRef.current;
    if (!d) return;
  ...
  function float(pid, txt, neg) {
    ...
    gg.hist[pid] = [{ id, txt, neg }].concat(gg.hist[pid] || []).slice(0, 3);
    R();
    setTimeout(() => {
  ...
  /* the player hands over the money themselves */
  async function confirmDue(amt, why, to, idx, oid) {
    const gg = Sr.current;
    const p = cur();
    if (!p.human || gg.winner !== null) { await sleep(420); return; }
    gg.sheet = { t: "due", amt, why, to, idx, oid };
    R();
    await awaitUI();
  }
  ...
  async function resolveLand() {
    ...
    if (sp.t === "prop" || sp.t === "station" || sp.t === "util") {
      ...
      if (o === undefined) {
        ...
        buzz(20);
        await confirmDue(rent, "Rent", gg.players[o].name, i, o);
        await charge(gg.cur, rent, o);
      }
    } else if (sp.t === "tax") {
      log(p.name + " pays " + sp.name + ": " + fmt(sp.amt) + ".");
      await confirmDue(sp.amt, sp.name, "the bank", i, -1);
  ...
  async function drawCard(deck) {
    ...
    gg.sheet = { t: "deck", deck };
    R();
    const dp = awaitUI();
    if (!p.human) setTimeout(() => { if (uiRes.current) uiDone(); }, 900);
    await dp;
    if (gg.winner !== null) return;
  ...
  function cycleTok(i) {
    S.tap();
    const used = setup.map((x) => x.tok);
    let n = KINDS.indexOf(setup[i].tok);
    for (let g = 0; g < KINDS.length; g++) {
      n = (n + 1) % KINDS.length;
      if (used.indexOf(KINDS[n]) < 0 || KINDS[n] === setup[i].tok) break;
    }
    setSetup(setup.map((x, j) => (j === i ? { ...x, tok: KINDS[n] } : x)));
  }
        ...
        <div className="suList">
          {setup.slice(0, count).map((s, i) => (
            <div key={i} className="suRow" style={{ borderLeftColor: PC[i] }}>
              <button className="suTokBtn" onClick={() => cycleTok(i)} title="Change piece">
                <Token i={i} kind={s.tok} cls="suPawn" />
              </button>
              <input
                className="suName"
                value={s.name}
  ...
  /* the rent ladder for one deed, with the row that is currently in force marked */
  function deedRows(i) {
    const sp = BOARD[i];
    const o = g.owner[i];
    const h = g.houses[i] || 0;
    if (sp.t === "prop") {
      const set = o != null && ownsFull(o, sp.g);
      const rows = [
        ["Rent", sp.r[0], h === 0 && !set],
        ["Colour set", sp.r[0] * 2, h === 0 && set],
        ["1 house", sp.r[1], h === 1],
        ["2 houses", sp.r[2], h === 2],
        ["3 houses", sp.r[3], h === 3],
        ["4 houses", sp.r[4], h === 4],
      ...
      return { rows, foot: [["House cost", "$" + GROUPS[sp.g].hc], ["Mortgage", "$" + sp.price / 2]] };
    }
    if (sp.t === "station") {
      let n = 0;
      [5, 15, 25, 35].forEach((k) => { if (o != null && g.owner[k] === o) n += 1; });
      return {
        rows: [["1 owned", 25, n === 1], ["2 owned", 50, n === 2], ["3 owned", 100, n === 3], ["4 owned", 200, n === 4]],
        foot: [["Mortgage", "$" + sp.price / 2]],
      };
    }
    const both = o != null && g.owner[12] === o && g.owner[28] === o;
    return {
  ...
  function renderSheet() {
    ...
    switch (sh.t) {
      ...
      case "due": {
        const short = cur().cash < sh.amt;
        const i = sh.idx;
        const sp = i != null && i >= 0 ? BOARD[i] : null;
        const deed = sp && sp.price !== undefined;
        const own = sh.oid != null && sh.oid >= 0 ? g.players[sh.oid] : null;
        const col = !sp ? "#9AA6B4"
          : sp.t === "prop" ? GROUPS[sp.g].c
          : sp.t === "station" ? "#9AA6B4"
          : sp.t === "util" ? "#4FA895" : "#C2483D";
        const h = sp ? g.houses[i] || 0 : 0;
        const rows = deed ? deedRows(i).rows : null;
        return (
          <Sheet onClose={null}>
            {sp && (
              <div className="dueCard">
                <div className="dueBar" style={{ background: col }} />
                <div className="dueHead">
                  <div className="dueWho">
                    <div className="dueName">{sp.name}</div>
                    <div className="dueMeta">
                      {deed ? fmt(sp.price) : "Tax"}
                      {h > 0 && <span className="dcH">{h === 5 ? "🏨 Hotel" : "🏠 ×" + h}</span>}
                    </div>
                  </div>
                  {own ? (
                    <div className="dueOwner" style={{ color: PC[own.id] }}>
                      <Token i={own.id} kind={own.tok} cls="duePawn" />
                      <div>
                        <div className="dueOwnL">Owned by</div>
                        <div className="dueOwnN">{own.name}</div>
                      </div>
                    </div>
                  ) : (
                    <div className="dueOwner"><div><div className="dueOwnL">Payable to</div><div className="dueOwnN">The bank</div></div></div>
                  )}
                </div>
                {rows && (
                  <div className="rTab dueTab">
                    {rows.map((r, n) => (
                      <div key={n} className={"rRow" + (r[2] ? " rNow" : "")}>
                        <span>{r[0]}</span>
                        <b>{typeof r[1] === "number" ? "$" + r[1] : r[1]}</b>
                      </div>
                    ))}
            ...
            <div className="dueLbl">{sh.why} due</div>
            <div className="dueBig" style={{ color: short ? "var(--danger)" : "var(--ink)" }}>{fmt(sh.amt)}</div>
      ...
      case "info": {
        ...
        return (
          <Sheet onClose={close}>
            ...
            {rentPreview(i)}
            {o === g.cur && cur().human && (g.phase === "pre" || g.phase === "post") && (
              <div className="shBtns">
                {sp.t === "prop" && (
                  <>
    ...
    return (
      <>
        <div className="hdr">
          ...
          <span className="hSp" />
          <button
            className={"hBtn hBtn3d" + (iso ? "" : " off")}
            aria-label={iso ? "Switch to flat view" : "Switch to 3D view"}
            onClick={() => { S.tap(); setIso(!iso); }}
          >3D</button>
          <button
        ...
        <div className="boardWrap">
          ...
          <div className="board">
            ...
            <div className="center">
              ...
              <div
                className={"diceRow" + (humanTurn && g.phase === "pre" && !p.inJail ? " diceLive" : "") + (drag ? " diceHeld" : "")}
                style={drag ? { transform: "translate(" + drag.dx * .35 + "px," + drag.dy * .35 + "px) rotate(" + drag.dx * .12 + "deg)" } : null}
                onPointerDown={throwStart}
                onPointerMove={throwMove}
                onPointerUp={throwEnd}
              ...
              {humanTurn && g.phase === "pre" && !p.inJail && (
                <div className="throwHint">{drag ? "release to throw" : "flick the dice"}</div>
              )}
